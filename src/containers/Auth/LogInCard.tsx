...
const LogInCard: React.FC = () => {
  ...
  const onLogin = (e: React.ChangeEvent<HTMLFormElement>) => {
    ...
    if(otpSent && otpInput.value) {
      const cr: firebase.auth.ConfirmationResult = (window as any).confirmationResult;
  ...
  return (
    <Card>
      ...
      <CardBody tag="form" onSubmit={onLogin} className="d-flex flex-column">
        ...
        <Button id="login-button" color="primary" type="submit" className="rounded-pill my-1">Log In</Button>
